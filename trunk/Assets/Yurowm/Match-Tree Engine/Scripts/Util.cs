...
namespace FBHandler
{
    ...
    {
        public static string GetPictureURLA(string facebookID, int? width = null, int? height = null, string type = null)
        {
        ...
        public static string GetPictureURLB(string facebookID, int? width = null, int? height = null, string type = null)
        {
            string url = string.Format("/{0}/picture", facebookID);
            string query = width != null ? "&width=" + width.ToString() : "";
            query += height != null ? "&height=" + height.ToString() : "";
